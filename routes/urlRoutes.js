...
//     return res.json({ message: "Short URL created successfully", shortUrl: newShortUrl });
...
// // Route to retrieve the original URL from the short URL
// router.get('/resolve/:shortUrl', async (req, res) => {
//   const { shortUrl } = req.params;
//   console.log("Requested Short URL:", shortUrl);
...
//   } catch (error) {
//     return res.status(500).json({ error: 'Error finding the URL.' });
//   }
// });
